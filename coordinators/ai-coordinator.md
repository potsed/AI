...
### AI Conflict Resolution Requirements
...
### AI Resource Allocation Requirements
...
### AI Monitoring and Oversight Requirements
...
|------------|-----------|-----|-------|
| **The Spanner** | Injects process questions and sanity checks into collaborations | [ai-spanner.md](https://raw.githubusercontent.com/potsed/AI/refs/tags/latest/agents/ai-spanner.md) | All agents, particularly coordinators |
...
| Agent Name | Specialty | URL | Peers |
|------------|-----------|-----|-------|
| **The Async Coordinator** | Manages, orchestrates, and optimizes asynchronous collaboration between AI agents | [async-coordinator.md](https://raw.githubusercontent.com/potsed/AI/refs/tags/latest/coordinators/async-coordinator.md) | All coordinators, particularly engineering and operations |
| **The Async Research Assistant** | Conducts independent research tasks asynchronously | [async-research-assistant.md](https://raw.githubusercontent.com/potsed/AI/refs/tags/latest/agents/async-research-assistant.md) | Research Analyst, Data Whisperer |
